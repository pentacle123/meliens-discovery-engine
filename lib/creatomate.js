...
function getTextConfig(style) {
  ...
  switch (style) {
    ...
    case 'info_bottom_bar':
      return { ...base, x: '50%', y: '75%', y_anchor: '50%', width: '90%', fill_color: '#FFFFFF', font_weight: '600', font_size: '5 vmin', background_color: 'rgba(0,0,0,0.6)', background_x_padding: '4 vmin', background_y_padding: '2 vmin', background_border_radius: '2 vmin' }
    ...
    case 'cta_animated':
      return { ...base, x: '50%', y: '70%', y_anchor: '50%', width: '85%', fill_color: '#FFFFFF', font_weight: '800', font_size: '7 vmin', background_color: 'rgba(99,102,241,0.85)', background_x_padding: '5 vmin', background_y_padding: '2.5 vmin', background_border_radius: '3 vmin' }
    case 'rating_display':
