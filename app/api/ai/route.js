...
STEP 1 — 자유 아이디어 생성:
위 제품 정보, 맥락 후보값, VOC 인사이트를 종합하여 먼저 아이디어 5개를 자유롭게 발상하세요.
...
4. data_evidence는 STEP 3의 검증 결과 이모지(🟢/🟡/🔵)로 시작하고, 검색 데이터 + VOC 근거를 한 줄로 통합 요약하세요.
  ...
  "instagram": {
    ...
    async function callClaude({ useMCP = false } = {}) {
      ...
      const body = {
        ...
        max_tokens: type === 'context_match' ? 8192 : 2000,
